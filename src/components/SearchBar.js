  ...
  return (
    <div className="flex items-center gap-2 bg-gray-100 rounded">
      <div className="relative">
        ...
        />
        <span className={`placeholder-text absolute left-0 top-1/2 -translate-y-1/2 w-full pointer-events-none text-gray-500 px-4 ${searchValue !== "" && "opacity-0 left-4"} transition-all duration-500`}>Search for movies, tv-shows or people</span>
      </div>
